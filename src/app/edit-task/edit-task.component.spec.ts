...
describe('EditTaskComponent', () => {
  ...
  it('should select a contact and close the contacts dropdown', () => {
    const contact: Contact = { id: 1, name: 'John Doe', email: 'john@example.com', phone: '1234567890', color: '#FF0000', initials: 'JD' };
    const event = new MouseEvent('click');
  ...
  it('should log form errors', () => {
    ...
    expect(console.error).toHaveBeenCalledWith('Form Errors:', jasmine.objectContaining({
